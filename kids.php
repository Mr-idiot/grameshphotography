...
<head>
<title>Ramesh Photography | Kids</title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/kids">Kids</a></li>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/kids/Kids1.jpg" />
                <img u="thumb" src="img/kids/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/kids/Kids2.jpg" />
                <img u="thumb" src="img/kids/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/kids/Kids3.jpg" />
                <img u="thumb" src="img/kids/thumb-3.jpg" />
            </div>
            <div>
