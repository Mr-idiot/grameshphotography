...
<head>
<title>Ramesh Photography | Commercial</title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/commercial">Commercial</a></li>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/commercial/Commercial1.jpg" />
                <img u="thumb" src="img/commercial/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial2.jpg" />
                <img u="thumb" src="img/commercial/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial3.jpg" />
                <img u="thumb" src="img/commercial/thumb-3.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial4.jpg" />
                <img u="thumb" src="img/commercial/thumb-4.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial5.jpg" />
                <img u="thumb" src="img/commercial/thumb-5.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial6.jpg" />
                <img u="thumb" src="img/commercial/thumb-6.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial7.jpg" />
                <img u="thumb" src="img/commercial/thumb-7.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial8.jpg" />
                <img u="thumb" src="img/commercial/thumb-8.jpg" />
            </div>
            <div>
                <img u="image" src="img/commercial/Commercial9.jpg" />
                <img u="thumb" src="img/commercial/thumb-9.jpg" />
            </div>
            <!--<div>
                <img u="image" src="img/commercial/Candid10.jpg" />
                <img u="thumb" src="img/commercial/thumb-10.jpg" />
            </div>
