...
<head>
<title>Ramesh Photography | Interior </title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/interior">Interior</a></li>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/interior/Interior0.jpg" />
                <img u="thumb" src="img/interior/thumb-0.jpg" />
            </div>
            <div>
                <img u="image" src="img/interior/Interior1.jpg" />
                <img u="thumb" src="img/interior/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/interior/Interior2.jpg" />
                <img u="thumb" src="img/interior/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/interior/Interior3.jpg" />
                <img u="thumb" src="img/interior/thumb-3.jpg" />
            </div>
            <div>
                <img u="image" src="img/interior/Interior4.jpg" />
                <img u="thumb" src="img/interior/thumb-4.jpg" />
            </div>
            <div>
                <img u="image" src="img/interior/Interior5.jpg" />
                <img u="thumb" src="img/interior/thumb-5.jpg" />
            </div>
<!--            <div>
                <img u="image" src="img/food/food6.jpg" />
                <img u="thumb" src="img/food/thumb-06.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/food7.jpg" />
                <img u="thumb" src="img/food/thumb-07.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/food9.jpg" />
                <img u="thumb" src="img/food/thumb-09.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/food9a.jpg" />
                <img u="thumb" src="img/food/thumb-9a.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/food10.jpg" />
                <img u="thumb" src="img/food/thumb-10.jpg" />
            </div>
            
            <div>
                <img u="image" src="img/food/food11.jpg" />
                <img u="thumb" src="img/food/thumb-11.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/food12a.jpg" />
                <img u="thumb" src="img/food/thumb-12a.jpg" />
            </div>
-->        
	</div>
