...
<head>
<title>Ramesh Photography | Product</title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/product">Product</a></li>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/product/Product1.jpg" />
                <img u="thumb" src="img/product/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product1a.jpg" />
                <img u="thumb" src="img/product/thumb-1a.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product2.jpg" />
                <img u="thumb" src="img/product/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product3.jpg" />
                <img u="thumb" src="img/product/thumb-3.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product4.jpg" />
                <img u="thumb" src="img/product/thumb-4.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product5.jpg" />
                <img u="thumb" src="img/product/thumb-5.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product6.jpg" />
                <img u="thumb" src="img/product/thumb-6.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product7.jpg" />
                <img u="thumb" src="img/product/thumb-7.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product10.jpg" />
                <img u="thumb" src="img/product/thumb-10.jpg" />
            </div>
            
            <div>
                <img u="image" src="img/product/Product11.jpg" />
                <img u="thumb" src="img/product/thumb-11.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product12.jpg" />
                <img u="thumb" src="img/product/thumb-12.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product13.jpg" />
                <img u="thumb" src="img/product/thumb-13.jpg" />
            </div>
             <div>
                <img u="image" src="img/product/Product13a.jpg" />
                <img u="thumb" src="img/product/thumb-13a.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product14.jpg" />
                <img u="thumb" src="img/product/thumb-14.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product15.jpg" />
                <img u="thumb" src="img/product/thumb-15.jpg" />
            </div>
            <div>
                <img u="image" src="img/product/Product16.jpg" />
                <img u="thumb" src="img/product/thumb-16.jpg" />
            </div>
        </div>
