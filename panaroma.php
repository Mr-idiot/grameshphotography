...
<head>
<title>Ramesh Photography | Panaroma</title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/panaroma">Panaroma</a></li>
        </ul>
     </div>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/panaroma/Panaroma1.jpg" />
                <img u="thumb" src="img/panaroma/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/panaroma/Panaroma2.jpg" />
                <img u="thumb" src="img/panaroma/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/panaroma/Panaroma3.jpg" />
                <img u="thumb" src="img/panaroma/thumb-3.jpg" />
            </div>
<!--            <div>
