...
<head>
<title>Ramesh Photography | food</title>
<meta charset="utf-8">
  ...
  <div class="row">
  	<div class="col row g-12 max-bottom">
        <ul id="works_filter" class="posifix">
          ...
          <li class="col row g-1"><a class="selected" href="http://www.grameshphotography.in/food">Food</a></li>
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width:1920px; height: 1485px; background:#d10015; overflow: hidden;">
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1920px; height: 1385px; overflow: hidden;">
            <div>
                <img u="image" src="img/food/Food1.jpg" />
                <img u="thumb" src="img/food/thumb-1.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/Food2.jpg" />
                <img u="thumb" src="img/food/thumb-2.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/Food3.jpg" />
                <img u="thumb" src="img/food/thumb-3.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/Food4.jpg" />
                <img u="thumb" src="img/food/thumb-4.jpg" />
            </div>
            <div>
                <img u="image" src="img/food/Food5.jpg" />
                <img u="thumb" src="img/food/thumb-5.jpg" />
            </div>
<!--            <div>
